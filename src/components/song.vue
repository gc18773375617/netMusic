...
<script>
	export default{
		...
		mounted() {
			...
			this.axios.get("http://121.42.15.67:3000/song/url?id="+songId)
			.then(res=>{
			...
			this.axios.get("http://121.42.15.67:3000/song/detail?ids="+songId)
			.then(res=>{
			...
			this.axios.get("http://121.42.15.67:3000/lyric?id="+songId)
			.then(res=>{
