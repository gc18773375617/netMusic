...
<script>
	export default{
		...
		mounted(){
			this.axios.get("http://121.42.15.67:3000/search/hot")
			.then(res=>{
				console.log(res)
		...
		methods: {
			sea(msg) {
				...
				this.axios.get("http://121.42.15.67:3000/search/suggest?keywords="+msg)
				.then(res=>{
			...
			seaRe(keymsg){
				...
				this.axios.get("http://121.42.15.67:3000/search/multimatch?keywords="+keymsg)
				.then(res=>{
					console.log(res)
					this.isResult = false;
					this.listShow = false;
				...
				this.axios.get("http://121.42.15.67:3000/search?keywords="+keymsg)
				.then(res=>{
